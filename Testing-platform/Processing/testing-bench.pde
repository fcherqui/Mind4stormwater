...
*/ 
String ProcessingCodeVersion="v02_01";
String filepath="C:\\Users\\Administrator\\Dropbox\\LOW_COST_SENSORS_Testing-Bench\\90_Test-results\\"; //where to save the results, default: "C:\\Users\\Administrator\\Dropbox\\LOW_COST_SENSORS_Testing-Bench\\90_Test-results\\"

//CONFIG//////////
String comPort="COM3";                                //Change for arduino com port (From arduino IDE or device manager)
...
void setup(){
  ...
  loggerln(" ");
  loggerln(" Starting serial communication, wait 5 seconds please...");
...
void serialEvent(Serial myPort){
  ...
  if (val!=null) { //CONDITION message not null
    if (val.contains("Something_wrong")){
      logger(val);
      phase="Exit";
